...
replaceInFile(path.join(__dirname, 'src', 'app', 'admin', 'page.jsx'));
replaceInFile(path.join(__dirname, 'src', 'components', 'Contact.jsx'));
replaceInFile(path.join(__dirname, 'src', 'components', 'Services.jsx'));
